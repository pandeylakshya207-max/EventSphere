        ...
        <form onSubmit={handleSubmit} className="space-y-12 pb-24">
          <section className="glass-card p-8 space-y-6 border-white/5">
            ...
            <div className="space-y-2">
              ...
              <textarea name="description" rows={4} placeholder="Describe what makes this event special..." className="w-full bg-white/5 border border-white/10 rounded-xl py-3 px-4 focus:border-brand-purple outline-none resize-none text-white transition-all" />
            </div>
          </section>
